    ...
    t.prototype.panBox_ = function(e) {
        ...
        if (!e && (t = this.getMap())instanceof google.maps.Map) {
            ...
            if (2 == t.panToBounds.length) {
                ...
                u.left = -o + l,
                u.right = o + s + l,
                this.alignBottom_ ? (u.top = -r + c + a,
                u.bottom = r + c) : (u.top = -r + c,
                u.bottom = r + a + c),
                ...
                if (p.x < -o + l ? i = p.x + o - l : p.x + s + o + l > d && (i = p.x + s + o + l - d),
                this.alignBottom_ ? p.y < -r + c + a ? n = p.y + r - c - a : p.y + r + c > f && (n = p.y + r + c - f) : p.y < -r + c ? n = p.y + r - c : p.y + a + r + c > f && (n = p.y + a + r + c - f),
                0 !== i || 0 !== n) {
                    t.getCenter();
                    t.panBy(i, n)
                }
...
!function(r, h, d) {
    ...
    function s(e, t, i, n) {
        ...
        u.appendChild(c),
        o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(h.createTextNode(e)),
        c.id = l,
    ...
    function n(e, t, i, n, o) {
        ...
        return f(t, "string") || f(t, "undefined") ? function(e, t, i, n) {
            ...
            if (n = !f(n, "undefined") && n,
            !f(i, "undefined")) {
                var r = m(e, i);
                if (!f(r, "undefined"))
                    return r
            }
            for (var s, a, l, c, u, h = ["modernizr", "tspan", "samp"]; !w.style && h.length; )
                s = !0,
                w.modElem = p(h.shift()),
            ...
            a = 0; a < l; a++)
                if (c = e[a],
                u = w.style[c],
                !~("" + c).indexOf("-") || (c = c.replace(/([a-z])-([a-z])/g, function(e, t, i) {
            ...
            for (var o in e)
                if (e[o]in t)
                    return !1 === i ? e[o] : f(n = t[e[o]], "function") ? a(n, i || t) : n;
            return !1
    ...
    function() {
        ...
        for (var s in c)
            if (c.hasOwnProperty(s)) {
                ...
                for (n = f(t.fn, "function") ? t.fn() : t.fn,
                o = 0; o < e.length; o++)
                    1 === (r = e[o].split(".")).length ? u[r[0]] = n : (!u[r[0]] || u[r[0]]instanceof Boolean || (u[r[0]] = new Boolean(u[r[0]])),
                    u[r[0]][r[1]] = n),
                    l.push((n ? "" : "no-") + r.join("-"))
            }
    }(),
    ...
    return function() {
        ...
        function s(e, t) {
            ...
            var l, c, u, h, d = !1, f = function() {
                e.resizedAttached && (d && (e.resizedAttached.call(),
                d = !1),
                g(f))
            };
            g(f);
            function p() {
                (u = e.offsetWidth) == l && (h = e.offsetHeight) == c || (d = !0,
                l = u,
                c = h),
                o()
            }
...
function(e, t) {
    ...
    C.extend({
        ...
        makeArray: function(e, t) {
            var i = t || [];
            return null != e && (d(Object(e)) ? C.merge(i, "string" == typeof e ? [e] : e) : l.call(i, e)),
            i
        },
    ...
    var f = function(i) {
        ...
        var e, f, _, r, s, p, d, m, w, l, c, x, E, a, S, g, u, v, y, C = "sizzle" + 1 * new Date, b = i.document, T = 0, n = 0, k = le(), A = le(), D = le(), I = le(), L = function(e, t) {
            return e === t && (c = !0),
            0
            ...
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, B = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", q = "\\[" + H + "*(" + R + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + H + "*\\]", F = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + q + ")*)|.*)\\)|)", W = new RegExp(H + "+","g"), $ = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), V = new RegExp("^" + H + "*," + H + "*"), U = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), Y = new RegExp(H + "|>"), Q = new RegExp(F), X = new RegExp("^" + R + "$"), G = {
            ID: new RegExp("^#(" + R + ")"),
            CLASS: new RegExp("^\\.(" + R + ")"),
            TAG: new RegExp("^(" + R + "|[*])"),
            ATTR: new RegExp("^" + q),
        ...
        }, K = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ie = /[+~]/, ne = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)","ig"), oe = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, re = function(e, t) {
        ...
        function ae(t, e, i, n) {
            ...
            "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d)
                return i;
            if (!n && ((e ? e.ownerDocument || e : b) !== E && x(e),
            e = e || E,
            S)) {
                if (11 !== d && (l = te.exec(t)))
                    if (o = l[1]) {
                ...
                if (f.qsa && !I[t + " "] && (!g || !g.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    ...
                    h = e,
                    1 === d && Y.test(t)) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(oe, re) : e.setAttribute("id", a = C),
                        r = (c = p(t)).length; r--; )
                            c[r] = "#" + a + " " + be(c[r]);
                        u = c.join(","),
                        h = ie.test(t) && ve(e.parentNode) || e
                    }
                    try {
        ...
        x = ae.setDocument = function(e) {
            ...
            u = [],
            g = [],
            (f.qsa = ee.test(E.querySelectorAll)) && (ue(function(e) {
        ...
        ae.matchesSelector = function(e, t) {
            if ((e.ownerDocument || e) !== E && x(e),
            f.matchesSelector && S && !I[t + " "] && (!u || !u.test(t)) && (!g || !g.test(t)))
                try {
                    var i = v.call(e, t);
        ...
        (_ = ae.selectors = {
            ...
            filter: {
                ...
                CHILD: function(p, e, t, m, g) {
                    ...
                    : function(e, t, i) {
                        var n, o, r, s, a, l, c = v != y ? "nextSibling" : "previousSibling", u = e.parentNode, h = b && e.nodeName.toLowerCase(), d = !i && !b, f = !1;
                        if (u) {
                            if (v) {
                                for (; c; ) {
                                    for (s = e; s = s[c]; )
                            ...
                            y && d) {
                                for (f = (a = (n = (o = (r = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && n[1]) && n[2],
                                s = a && u.childNodes[a]; s = ++a && s && s[c] || (f = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++f && s === e) {
                                        o[p] = [T, a, f];
                                        break
                                    }
                            } else if (d && (f = a = (n = (o = (r = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === T && n[1]),
                            !1 === f)
                                for (; (s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((o = (r = s[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [T, f]),
                                s !== e)); )
                                    ;
            ...
            ce(function(e, t, i, n) {
                var o, r, s, a = [], l = [], c = t.length, u = e || function(e, t, i) {
                    for (var n = 0, o = t.length; n < o; n++)
                        ae(e, t[n], i);
                    return i
                }(p || "*", i.nodeType ? [i] : i, []), h = !f || !e && p ? u : xe(u, a, f, i, n), d = m ? v || (e ? f : c || g) ? [] : t : h;
                if (m && m(h, d, i, n),
                g)
                    for (o = xe(d, l),
                    g(o, [], i, n),
                ...
                if (e) {
                    if (v || f) {
                        ...
                        for (r = d.length; r--; )
                            (s = d[r]) && -1 < (o = v ? z(e, s) : a[r]) && (e[o] = !(t[o] = s))
                    }
                } else
                    d = xe(d === t ? d.splice(c, d.length) : d),
                    v ? v(null, t, d, n) : O.apply(t, d)
            })
        }
        function Se(e) {
            ...
            if (!r) {
                ...
                (r = D(e, function(g, v) {
                    function e(e, t, i, n, o) {
                        var r, s, a, l = 0, c = "0", u = e && [], h = [], d = w, f = e || b && _.find.TAG("*", o), p = T += null == d ? 1 : Math.random() || .1, m = f.length;
                        ...
                        y && c !== l) {
                            ...
                            O.apply(n, h),
                            o && !e && 0 < h.length && 1 < l + v.length && ae.uniqueSort(n)
                        }
                        return o && (T = p,
                        w = d),
                        u
        ...
        m = ae.select = function(e, t, i, n) {
            ...
            return (c || d(e, u))(n, t, !S, i, !t || ie.test(e) && ve(t.parentNode) || t),
            i
        }
        ,
    ...
    (C.fn.init = function(e, t, i) {
        ...
        "string" != typeof e)
            ...
            this.length = 1,
            this) : b(e) ? void 0 !== i.ready ? i.ready(e) : e(C) : C.makeArray(e, this);
        if (!(n = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : L.exec(e)) || !n[1] && t)
            return !t || t.jquery ? (t || i).find(e) : this.constructor(t).find(e);
        if (n[1]) {
            if (t = t instanceof C ? t[0] : t,
            C.merge(this, C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : S, !0)),
    ...
    C.each({
        ...
        C.fn[n] = function(e, t) {
            ...
            1 < this.length && (j[n] || C.uniqueSort(i),
            P.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    C.extend({
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    b(t) ? a ? t.call(e, c(l, r, M, a), c(l, r, z, a)) : (l++,
                                    t.call(e, c(l, r, M, a), c(l, r, z, a), c(l, r, M, r.notifyWith))) : (s !== M && (i = void 0,
                                    n = [e]),
                                    (a || r.resolveWith)(i, n))
                                }
                            }
        ...
        when: function(e) {
            ...
            var i = arguments.length
              ...
              , r = a.call(arguments)
              , s = C.Deferred();
            if (i <= 1 && (B(e, s.done(t(n)).resolve, s.reject, !i),
    ...
    C.ready.then = R.then,
    "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? E.setTimeout(C.ready) : (S.addEventListener("DOMContentLoaded", q),
        ...
        data: function(i, e) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var t;
                    if (r && void 0 === e)
                        return void 0 !== (t = G.get(r, i)) ? t : void 0 !== (t = Z(r, i)) ? t : void 0;
                    this.each(function() {
                        G.set(this, i, e)
                    })
            ...
            1 === r.nodeType && !X.get(r, "hasDataAttrs"))) {
                for (t = s.length; t--; )
                    s[t] && 0 === (n = s[t].name).indexOf("data-") && (n = U(n.slice(5)),
                    Z(r, n, o[n]));
    ...
    C.extend({
        queue: function(e, t, i) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                n = X.get(e, t),
                i && (!n || Array.isArray(i) ? n = X.access(e, t, C.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    C.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (n = X.get(s[a], e + "queueHooks")) && n.empty && (o++,
                n.empty.add(i));
            return i(),
            r.promise(t)
        }
    ...
    function le(e, t, i, n) {
        ...
        , l = a(), c = i && i[3] || (C.cssNumber[t] ? "" : "px"), u = e.nodeType && (C.cssNumber[t] || "px" !== c && +l) && te.exec(C.css(e, t));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; s--; )
    ...
    function ue(e, t) {
        for (var i, n, o, r, s, a, l, c = [], u = 0, h = e.length; u < h; u++)
            ...
            t ? ("none" === i && (c[u] = X.get(n, "display") || null,
            c[u] || (n.style.display = "")),
            "" === n.style.display && ae(n) && (c[u] = (l = s = r = void 0,
            s = (o = n).ownerDocument,
            a = o.nodeName,
            (l = ce[a]) || (r = s.body.appendChild(s.createElement(a)),
            l = C.css(r, "display"),
            r.parentNode.removeChild(r),
            "none" === l && (l = "block"),
            ce[a] = l)))) : "none" !== i && (c[u] = "none",
            X.set(n, "display", i)));
        for (u = 0; u < h; u++)
        ...
        C.event.add(e, o, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[o]) {
                    ...
                    t = r(this, o),
                    this[o](),
                    n !== (i = X.get(this, o)) || t ? X.set(this, o, !1) : i = {},
                    n !== i)
    ...
    C.event = {
        ...
        dispatch: function(e) {
            var t, i, n, o, r, s, a = C.event.fix(e), l = new Array(arguments.length), c = (X.get(this, "events") || {})[a.type] || [], u = C.event.special[a.type] || {};
            for (l[0] = a,
            ...
            !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                ...
                t = 0; (o = s[t++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (r = o.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = r.data,
                        void 0 !== (n = ((C.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && k(t, "input") && Ae(t, "click", Se),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return he.test(t.type) && t.click && k(t, "input") && Ae(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function ze(i, n, o, r) {
        ...
        if (h && (t = (e = _e(n, i[0].ownerDocument, !1, i, r)).firstChild,
        ...
        t || r)) {
            ...
            if (a)
                ...
                u = 0; u < a; u++)
                    l = s[u],
                    fe.test(l.type || "") && !X.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
    ...
    function Be(e, t, i) {
        for (var n, o = t ? C.filter(t, e) : e, r = 0; null != (n = o[r]); r++)
            ...
            n.parentNode && (i && oe(n) && ge(me(n, "script")),
        ...
        clone: function(e, t, i) {
            ...
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                ...
                o = (r = me(e)).length; n < o; n++)
                    ...
                    l = s[n],
                    void 0,
                    "input" === (c = l.nodeName.toLowerCase()) && he.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (i)
                    for (r = r || me(e),
                    s = s || me(u),
                    ...
                    Me(e, u);
            return 0 < (s = me(u, "script")).length && ge(s, !h && me(e, "script")),
            u
        },
    ...
    C.fn.extend({
        ...
        replaceWith: function() {
            ...
            return ze(this, arguments, function(e) {
                ...
                C.inArray(this, i) < 0 && (C.cleanData(me(this)),
    ...
    function Ke(e, t, i) {
        ...
        return (i = i || Ye(e)) && ("" !== (s = i.getPropertyValue(t) || i[t]) || oe(e) || (s = C.style(e, t)),
        !y.pixelBoxStyles() && Ue.test(s) && Qe.test(t) && (n = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    (Ve = S.createElement("div")).style && (Ve.style.backgroundClip = "content-box",
    ...
    function ct(e, t, i) {
        ...
        return (!y.boxSizingReliable() && o || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, n)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, n),
        (r = a in e) && (s = e[a])),
        (s = parseFloat(s) || 0) + lt(e, t, i || (o ? "border" : "content"), r, n, s) + "px"
    }
    ...
    C.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (r = typeof i) && (o = te.exec(i)) && o[1] && (i = le(e, t, o),
                r = "number"),
    ...
    C.each(["height", "width"], function(e, l) {
        C.cssHooks[l] = {
            get: function(e, t, i) {
                if (t)
                    return !nt.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, l, i) : se(e, rt, function() {
                        return ct(e, l, i)
                    })
            },
            set: function(e, t, i) {
                var n, o = Ye(e), r = !y.scrollboxSize() && "absolute" === o.position, s = (r || i) && "border-box" === C.css(e, "boxSizing", !1, o), a = i ? lt(e, l, i, s, o) : 0;
                return s && r && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - lt(e, l, "border", !1, o) - .5)),
                a && (n = te.exec(t)) && "px" !== (n[3] || "px") && (e.style[l] = t,
                t = C.css(e, l)),
                at(0, t, a)
            }
        }
    ...
    function vt() {
        dt && (!1 === S.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(vt) : E.setTimeout(vt, C.fx.interval),
        C.fx.tick())
    }
    function yt() {
    ...
    function wt(r, e, t) {
        var i, s, n = 0, o = wt.prefilters.length, a = C.Deferred().always(function() {
            ...
            if (s)
                return !1;
            for (var e = ht || yt(), t = Math.max(0, c.startTime + c.duration - e), i = 1 - (t / c.duration || 0), n = 0, o = c.tweens.length; n < o; n++)
                c.tweens[n].run(i);
    ...
    C.Animation = C.extend(wt, {
        tweeners: {
            "*": [function(e, t) {
                ...
                return le(i.elem, e, te.exec(t), i),
                i
            }
            ]
        },
        tweener: function(e, t) {
            ...
            ["*"]) : e.match(O)).length; n < o; n++)
                i = e[n],
                wt.tweeners[i] = wt.tweeners[i] || [],
                wt.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            var n, o, r, s, a, l, c, u, h = "width"in t || "height"in t, d = this, f = {}, p = e.style, m = e.nodeType && ae(e), g = X.get(e, "fxshow");
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(f))
                ...
                "none" === (u = C.css(e, "display")) && (c ? u = c : (ue([e], !0),
                c = e.style.display || c,
                u = C.css(e, "display"),
                ue([e]))),
    ...
    C.extend({
        attr: function(e, t, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === e.getAttribute ? C.prop(e, t, i) : (1 === r && C.isXMLDoc(e) || (o = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? xt : void 0)),
        ...
        toggleClass: function(o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : b(o) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== o && "boolean" != r || ((e = kt(this)) && X.set(this, "__className__", e),
    ...
    C.extend(C.event, {
        trigger: function(e, t, i, n) {
            var o, r, s, a, l, c, u, h, d = [i || S], f = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = h = s = i = i || S,
            3 !== i.nodeType && 8 !== i.nodeType && !Lt.test(f + C.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(),
            p.sort()),
            l = f.indexOf(":") < 0 && "on" + f,
            (e = e[C.expando] ? e : new C.Event(f,"object" == typeof e && e)).isTrigger = n ? 2 : 3,
            e.namespace = p.join("."),
            ...
            n || !u.trigger || !1 !== u.trigger.apply(i, t))) {
                if (!n && !u.noBubble && !m(i)) {
                    ...
                    Lt.test(a + f) || (r = r.parentNode); r; r = r.parentNode)
                        d.push(r),
                        s = r;
                ...
                return e.type = f,
                n || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), t) || !Y(i) || l && b(i[f]) && !m(i) && ((s = i[l]) && (i[l] = null),
                C.event.triggered = f,
    ...
    y.focusin || C.each({
        ...
        C.event.special[n] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this
                  , t = X.access(e, n) - 1;
                t ? X.access(e, n, t) : (e.removeEventListener(i, o, !0),
                X.remove(e, n))
            }
        }
    });
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var u, h, d, i, f, n, p, m, o, r, g = C.ajaxSetup({}, t), v = g.context || g, y = g.context && (v.nodeType || v.jquery) ? C(v) : C.event, b = C.Deferred(), _ = C.Callbacks("once memory"), w = g.statusCode || {}, s = {}, a = {}, l = "canceled", x = {
                readyState: 0,
            ...
            if (b.promise(x),
            g.url = ((e || g.url || Pt.href) + "").replace(Vt, Pt.protocol + "//"),
            ...
            null == g.crossDomain) {
                ...
                try {
                    n.href = g.url,
                    n.href = n.href,
                    g.crossDomain = Xt.protocol + "//" + Xt.host != n.protocol + "//" + n.host
                } catch (e) {
                    g.crossDomain = !0
                }
            }
            ...
            h = g.url.replace(qt, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Rt, "+")) : (r = g.url.slice(h.length),
            g.data && (g.processData || "string" == typeof g.data) && (h += (Nt.test(h) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (h = h.replace(Ft, "$1"),
            r = (Nt.test(h) ? "&" : "?") + "_=" + jt++ + r),
            g.url = h + r),
            g.ifModified && (C.lastModified[h] && x.setRequestHeader("If-Modified-Since", C.lastModified[h]),
            ...
            x.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Qt + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
            ...
            function c(e, t, i, n) {
                ...
                o ? (g.ifModified && ((l = x.getResponseHeader("Last-Modified")) && (C.lastModified[h] = l),
                ...
                send: function(e, t) {
                    ...
                    r = function(e) {
                        return function() {
                            ...
                            "abort" === e ? n.abort() : "error" === e ? "number" != typeof n.status ? t(0, "error") : t(n.status, n.statusText) : t(Zt[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    C.ajaxPrefilter("json jsonp", function(e, t, i) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
            ...
            s ? e[s] = e[s].replace(ni, "$1" + n) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + n),
    ...
    y.createHTMLDocument = ((ti = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    C.parseHTML = function(e, t, i) {
        ...
        r = !i && [],
        (o = A.exec(e)) ? [t.createElement(o[1])] : (o = _e([e], t, r),
    ...
    C.offset = {
        setOffset: function(e, t, i) {
            ...
            r = C.css(e, "top"),
            l = C.css(e, "left"),
            o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (s = (n = u.position()).top,
        ...
        C.each({
            ...
            C.fn[r] = function(e, t) {
                ...
                return F(this, function(e, t, i) {
                    ...
                    Math.max(e.body["scroll" + s], n["scroll" + s], e.body["offset" + s], n["offset" + s], n["client" + s])) : void 0 === i ? C.css(e, t, o) : C.style(e, t, i, o)
                }, a, i ? e : void 0, i)
            }
        })
    }),
...
function(e, t) {
      ...
      , b = function() {
        ...
        return e.toggle = function() {
            ...
            if (i) {
                ...
                if (n) {
                    if ("radio" === n.type)
                        if (n.checked && this._element.classList.contains(g))
                            e = !1;
                        else {
                            var o = i.querySelector(".active");
                            o && p(o).removeClass(g)
                        }
                    e && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains(g)),
                    p(n).trigger("change")),
                    n.focus(),
                    t = !1
                }
            }
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(g)),
    ...
    p(document).on("click.bs.button.data-api", v, function(e) {
        ...
        !t || t.hasAttribute("disabled") || t.classList.contains("disabled"))
            ...
            "LABEL" === i.tagName && n && "checkbox" === n.type && e.preventDefault(),
    ...
    var _ = "carousel"
      ...
      , P = function() {
        ...
        e._slide = function(e, t) {
            var i, n, o, r = this, s = this._element.querySelector(I), a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), c = this._getItemIndex(l), u = Boolean(this._interval);
            if (o = e === T ? (i = "carousel-item-left",
            ...
            l && p(l).hasClass(D))
                ...
                if (p(this._element).hasClass("slide")) {
                    ...
                    p(s).one(m.TRANSITION_END, function() {
                        p(l).removeClass(i + " " + n).addClass(D),
    ...
    p(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", P._dataApiClickHandler),
    ...
    var j = "collapse"
      ...
      , W = function() {
        ...
        e.show = function() {
            ...
            !(e && (t = p(e).not(this._selector).data(N)) && t._isTransitioning))) {
                ...
                !n.isDefaultPrevented()) {
                    ...
                    this._triggerArray.length && p(this._triggerArray).removeClass(q).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var r = "scroll" + (o[0].toUpperCase() + o.slice(1))
                      , s = m.getTransitionDurationFromElement(this._element);
                    p(this._element).one(m.TRANSITION_END, function() {
                        p(i._element).removeClass(R).addClass(H + " " + B),
                        i._element.style[o] = "",
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && p(this._element).hasClass(B)) {
                ...
                !t.isDefaultPrevented()) {
                    ...
                    p(this._element).addClass(R).removeClass(H + " " + B);
                    ...
                    if (0 < n)
                        for (var o = 0; o < n; o++) {
                            var r = this._triggerArray[o]
                              , s = m.getSelectorFromElement(r);
                            if (null !== s)
                                p([].slice.call(document.querySelectorAll(s))).hasClass(B) || p(r).addClass(q).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    p(this._element).one(m.TRANSITION_END, function() {
                        ...
                        p(e._element).removeClass(R).addClass(H).trigger("hidden.bs.collapse")
        ...
        ,
        e._getConfig = function(e) {
            return (e = l(l({}, M), e)).toggle = Boolean(e.toggle),
    ...
    var $ = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , V = function() {
        for (var e = ["Edge", "Trident", "Firefox"], t = 0; t < e.length; t += 1)
            if ($ && 0 <= navigator.userAgent.indexOf(e[t]))
                return 1;
        return 0
    }();
    ...
    function te(e) {
        ...
        for (var t = ee(10) ? document.body : null, i = e.offsetParent || null; i === t && e.nextElementSibling; )
    ...
    function Ee(e, i, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, i) {
            ...
            e.enabled && Y(t) && (i.offsets.popper = de(i.offsets.popper),
    ...
    function ke(e, t, i, n) {
        i.updateBound = n,
        Te(e).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var o = G(e);
    ...
    function Ae() {
        ...
        this.state = function(e, t) {
            return Te(e).removeEventListener("resize", t.updateBound),
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    e.arrowElement = n,
                    e.offsets.arrow = (ue(i = {}, h, Math.round(b)),
                    ue(i, d, ""),
                    i),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(m, g) {
                    if (Se(m.instance.modifiers, "inner"))
                        return m;
                    ...
                    return w.forEach(function(e, t) {
                        ...
                        m.placement = y + (_ ? "-" + _ : ""),
                        m.offsets.popper = he({}, m.offsets.popper, we(m.instance.popper, m.offsets.reference, m.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    return e.attributes = he({}, y, e.attributes),
    ...
    function Fe(e, t) {
        ...
        Object.keys(he({}, Fe.Defaults.modifiers, n.modifiers)).forEach(function(e) {
    ...
    var We = "dropdown"
      ...
      , st = function() {
        ...
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || p(this._element).hasClass(Ze) || p(this._menu).hasClass(et))) {
                var t = {
                ...
                !i.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        ...
                        var o = this._element;
                        "parent" === this._config.reference ? o = n : m.isElement(this._config.reference) && (o = this._config.reference,
                        ...
                        this._popper = new qe(o,this._menu,this._getPopperConfig())
                    }
        ...
        e._getPlacement = function() {
            var e = p(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = p(this._menu).hasClass(tt) ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : p(this._menu).hasClass(tt) && (t = "bottom-end"),
            t
        }
        ,
            ...
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(nt).length)) : Qe.test(e.which)) && !this.disabled && !p(this).hasClass(Ze)) {
                ...
                if (i || 27 !== e.which) {
                    ...
                    !i || i && (27 === e.which || 32 === e.which))
                        return 27 === e.which && p(t.querySelector(it)).trigger("focus"),
      ...
      , Tt = function() {
        ...
        e.show = function(e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                p(this._element).on(vt, '[data-dismiss="modal"]', function(e) {
                    return t.hide(e)
                }),
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(i.body.querySelectorAll("*")), n = function(e, t) {
            ...
            o.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(i))
                        return -1 === kt.indexOf(i) || Boolean(e.nodeValue.match(Dt) || e.nodeValue.match(It));
      ...
      , Qt = function() {
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this._popper = new qe(this.element,o,this._getPopperConfig(a)),
                p(o).addClass(Vt),
        ...
        e.hide = function(e) {
            function t() {
                i._hoverState !== Ft && n.parentNode && n.parentNode.removeChild(n),
                i._cleanTipClass(),
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    p(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    });
                else if ("manual" !== e) {
        ...
        e._enter = function(e, t) {
            ...
            (t = t || p(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            p(e.currentTarget).data(i, t)),
            e && (t._activeTrigger["focusin" === e.type ? Yt : Ut] = !0),
            p(t.getTipElement()).hasClass(Vt) || t._hoverState === Ft ? t._hoverState = Ft : (clearTimeout(t._timeout),
            t._hoverState = Ft,
    ...
    var ri = "scrollspy"
      ...
      , gi = function() {
        function i(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + fi + "," + this._config.target + " " + pi + "," + this._config.target + " .dropdown-item",
            this._offsets = [],
            this._targets = [],
        ...
        e._activate = function(t) {
            ...
            i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(hi),
            i.addClass(hi)) : (i.addClass(hi),
            i.parents(di).prev(fi + ", " + pi).addClass(hi),
      ...
      , xi = function() {
        ...
        return e.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(bi) || p(this._element).hasClass("disabled"))) {
                var e, n, t = p(this._element).closest(".nav, .list-group")[0], o = m.getSelectorFromElement(this._element);
                if (t) {
    ...
    p(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(),
        xi._jQueryInterface.call(p(this), "show")
    }),
    ...
    var Ei = "toast"
      ...
      , Pi = function() {
        ...
        ,
        e._getConfig = function(e) {
            return e = l(l(l({}, Li), p(this._element).data()), "object" == typeof e && e ? e : {}),
    ...
    d._apply = function(e, t) {
        ...
        l.each(n, function(e, t) {
            ...
            i.each(function() {
                var e = l(this)
                  , t = 0;
                r.target && e.is(r.target) || ("border-box" !== e.css("box-sizing") && (t += c(e.css("border-top-width")) + c(e.css("border-bottom-width")),
        ...
        d._maintainScroll && l(window).scrollTop(o / s * l("html").outerHeight(!0)),
        this
    }
    ,
...
, function(e, t, i) {
    ...
    var a, y, h = v.window.navigator, d = -1 < h.userAgent.indexOf("MSIE ") || -1 < h.userAgent.indexOf("Trident/") || -1 < h.userAgent.indexOf("Edge/"), l = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(h.userAgent), f = function() {
    ...
    function b(e, t) {
        ...
        for (var i, n = e.length, o = 0, r = arguments.length, s = new Array(2 < r ? r - 2 : 0), a = 2; a < r; a++)
            s[a - 2] = arguments[a];
        for (; o < n; o += 1)
            if ("object" === u(t) || void 0 === t ? e[o].jarallax || (e[o].jarallax = new w(e[o],t)) : e[o].jarallax && (i = e[o].jarallax[t].apply(e[o].jarallax, s)),
            void 0 !== i)
                return i;
        return e
    }
    var _ = 0
      , w = function() {
        ...
        return function(e, t, i) {
            ...
            key: "css",
            value: function(t, i) {
                return "string" == typeof i ? v.window.getComputedStyle(t).getPropertyValue(i) : (i.transform && f && (i[f] = i.transform),
                Object.keys(i).forEach(function(e) {
                    t.style[e] = i[e]
                }),
                t)
            ...
            value: function(e) {
                ...
                e || t.isElementInViewport) {
                    var a = Math.max(0, n)
                      ...
                      , f = 1 - (y - n) / (y + o) * 2
                      , p = 1;
                    if (o < y ? p = 1 - (c || u) / o : l <= y ? p = l / y : h <= y && (p = h / y),
                ...
                t.prototype[m] = function() {
                    ...
                    case "onScroll":
                        var c = e.getWindowData()
                          ...
                          , f = h
                          , p = d;
                        null !== e.options.thresholdY && h > e.options.thresholdY && (f = 0),
                        null !== e.options.thresholdX && d > e.options.thresholdX && (p = 0),
                        e.css(e.$item, {
        ...
        return function(e, t, i) {
            ...
            value: function(l) {
                ...
                c.$video ? l(c.$video) : c.onAPIready(function() {
                    var e, t;
                    if (c.$video || ((e = document.createElement("div")).style.display = "none"),
                    "youtube" === c.type) {
                        var i, n;
                        c.playerOptions = {},
                        ...
                        c.playerOptions.events = {
                            onReady: function(t) {
                                if (c.options.mute ? t.target.mute() : c.options.volume && t.target.setVolume(c.options.volume),
                            ...
                            onStateChange: function(e) {
                                ...
                                i || e.data !== u.a.YT.PlayerState.PLAYING || (i = 1,
                                c.fire("started", e)),
                                ...
                                e.data === u.a.YT.PlayerState.PLAYING ? n = setInterval(function() {
                                    c.fire("timeupdate", e),
                        ...
                        o && (c.$video = document.getElementById(c.playerID),
                    ...
                    if ("vimeo" === c.type) {
                        ...
                        !c.$video) {
                            ...
                            Object.keys(c.playerOptions).forEach(function(e) {
                                "" !== s && (s += "&"),
                                s += "".concat(e, "=").concat(encodeURIComponent(c.playerOptions[e]))
                            }),
                            c.$video = document.createElement("iframe"),
                            c.$video.setAttribute("id", c.playerID),
                            c.$video.setAttribute("src", "https://player.vimeo.com/video/".concat(c.videoID, "?").concat(s)),
            ...
            value: function(e) {
                ...
                "vimeo" === this.type)
                    if (void 0 !== u.a.Vimeo || d)
                        void 0 !== u.a.Vimeo ? e() : p.done(function() {
                            e()
                        });
                    else {
                        d = 1;
...
function(e, t) {
    ...
    var C = {}
      ...
      , k = 0;
    function A(e) {
        return !!C[e] && (C[e].element.removeEventListener(T, C[e].listener),
        !(C[e] = null))
    }
    function D(e, t) {
        function i(e) {
    ...
    var M = 0
      , z = function() {
        ...
        e(r, [{
            ...
            value: function(e) {
                return function(e) {
                    for (var t = e.itemSize, i = e.positions, n = e.gridSize, o = e.total, r = e.threshold, s = e.buffer, a = L(t.width, n, o, r), l = P(i, a, o), c = j(l, s), u = new m(n * c,l[c]), h = l[c] + t.height, d = 0; d < a; d++)
                        i[c + d] = h;
                    return u
                }({
                    itemSize: e,
                ...
                value: function(e) {
                    if (!this._breakpoint) {
                        ...
                        if ((this.affixedType != t || e) && t) {
                            ...
                            "STATIC" === t ? u.removeClass(this.sidebar, this.options.stickyClass) : u.addClass(this.sidebar, this.options.stickyClass),
                            i.outer) {
